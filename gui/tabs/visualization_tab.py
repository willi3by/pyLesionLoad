...
class VisualizationTab(QWidget):
    ...
    def visualize_brain(self):
        ...
        if self.parent.lesion_side == "Left":
            tracts_path = 'data/HCPA/left_cst.trk'
        if self.parent.lesion_side == "Right":
            tracts_path = 'data/HCPA/right_cst.trk'
        ...
        if self.parent.lesion_side == "Left":
            grid_regions = natsorted(glob('data/HCPA/grid_16ths/sxHCPA_CST_Left*'))

        if self.parent.lesion_side == "Right":
            grid_regions = natsorted(glob('data/HCPA/grid_16ths/sxHCPA_CST_Right*'))
        ...
        if self.parent.lesion_side == "Left":
            radial_regions = natsorted(glob('data/HCPA/radial_16ths/left*'))

        if self.parent.lesion_side == "Right":
            radial_regions = natsorted(glob('data/HCPA/radial_16ths/right*'))
